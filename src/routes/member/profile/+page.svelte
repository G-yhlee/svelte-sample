...
<section class="fcc h-full mx-auto pt-20 select-none <md:(w-full)">
	<article
		class="fcc flex-col gap-10 w-200 mx-auto py-10 rounded-lg bg-green-100 bg-opacity-30 <md:(justify-start w-full h-full overflow-scroll)"
	>
		<p class="text-3xl font-bold">프로필 설정</p>
		...
		<button type="button" class="relative w-50 py-4 fcc rounded-lg bg-green-400 text-white <md:(w-4/5)">
			<span class="text-xl font-bold">확인</span>
		</button>
	</article>
</section>
